...
class VideoResponse(BaseModel):
    ...
    # Stream URL for video preview (generated by backend)
    stream_url: Optional[str] = Field(alias="streamUrl", serialization_alias="streamUrl", default=None)
    # Upload error (for failed uploads)
    last_upload_error: Optional[str] = Field(alias="lastUploadError", serialization_alias="lastUploadError", default=None)
    # Timestamps
